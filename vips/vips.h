...
// Custom image creation operations
...
// Custom multi-page operations (these are genuinely custom)
int remove_exif(VipsImage *in, VipsImage **out);
int embed_multi_page(VipsImage *in, VipsImage **out, int left, int top, int width, int height, int extend);
int embed_multi_page_background(VipsImage *in, VipsImage **out, int left, int top, int width, int height, double r, double g, double b, double a);
...
int label_image(VipsImage *in, VipsImage **out, const char *text, const char *font, int x, int y, int size, VipsAlign align, double r, double g, double b, float opacity);
